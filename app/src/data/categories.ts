...
export const SUBCATEGORIA_A_CATEGORIA: Record<string, CategoryMapping> = {
  ...
  'Accesorio': { categoria: 'Accesorios', subcategoria: { 'Piloto luminoso': 'Pilotaje', 'Contador eléctrico': 'Medida', 'CARRIL DIN': 'Distribución' } },
...
export const FULL_CATEGORY_INFO: Record<string, CategoryMeta> = {
  ...
  "DISTRIBUCION DE POTENCIA": { label: 'Distribución de potencia', icon: '⚡', desc: 'Aparamenta modular, envolventes, cuadros eléctricos y sistemas de gestión de cableado.', tip: 'Verifica la intensidad nominal (A), el poder de corte (kA) y el número de polos necesario.' },
